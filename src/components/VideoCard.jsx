...
const VideoCard = ({displayData,setDeleteVideoResponse,insideCategory}) => {
    ...
    const handleShow = async () => {
        ...
        const timeStamp = today.toLocaleString('en-IN',{timeZoneName:'short'})
  ...
  return (
    <>
        ...
        <Modal size='lg' centered show={show} onHide={handleClose}>
            ...
            <Modal.Body>
                <iframe width="100%" height="360" src={`${displayData?.link}?autoplay=1`} title={displayData?.caption} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
            </Modal.Body>
      </Modal>
    </>
  )
